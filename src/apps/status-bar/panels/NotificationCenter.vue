...
const notifications = computed(() => {
  // 返回排序后的通知（这里假设 store 中已经按时间倒序排列，如果没有则需要排序）
          ...
          >
            <div class="ios-notification-header">
              <DynamicAppIcon
                ...
                size="xs"
                :rounded="false"
                class="ios-notification-icon-wrapper"
              />
              <span class="ios-notification-app">{{ notification.appName }}</span>
              <span class="ios-notification-time">{{ formatTime(notification.timestamp) }}</span>
            </div>
            <div class="ios-notification-body">
              <div class="ios-notification-title">{{ notification.title }}</div>
              <div class="ios-notification-message">{{ notification.body }}</div>
            </div>
          </div>
        ...
        <div class="android-notifications">
          ...
          >
            <DynamicAppIcon
              ...
              size="sm"
              :rounded="true"
              class="android-notification-icon-wrapper"
            />
            <div class="android-notification-content">
              <div class="android-notification-top">
                <span class="android-notification-app">{{ notification.appName }}</span>
                <span class="android-notification-time">{{ formatTime(notification.timestamp) }}</span>
              </div>
              <div class="android-notification-title">{{ notification.title }}</div>
              <div class="android-notification-message">{{ notification.body }}</div>
            </div>
            <button 
        ...
        <div class="default-notifications">
          ...
          >
            <DynamicAppIcon
              ...
              size="md"
              :rounded="false"
              class="default-notification-icon-wrapper"
            />
            <div class="default-notification-content">
              <div class="default-notification-title">{{ notification.title }}</div>
              <div class="default-notification-message">{{ notification.body }}</div>
            </div>
            <span class="default-notification-time">{{ formatTime(notification.timestamp) }}</span>
          </div>
