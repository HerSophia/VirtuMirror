 ...
 */
export type AppChainDefinition = Omit<PromptChain, 'id' | 'createdAt' | 'updatedAt' | 'source' | 'appId'>;
...
export class PromptChainService {
  ...
  async getExecutionById(
    executionId: string
  ): Promise<ChainExecutionHistory | undefined> {
